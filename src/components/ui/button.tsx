...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-md shadow-black/5 hover:bg-primary/90 primary-glow dark:shadow-indigo-500/20",
        destructive:
          "bg-destructive/90 text-white hover:bg-destructive shadow-md shadow-black/5 dark:shadow-red-500/10",
        outline:
          "border border-border bg-transparent hover:bg-muted/80 hover:border-border dark:hover:border-indigo-500/35 hover:-translate-y-px",
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 hover:-translate-y-px",
        ghost:
          "hover:bg-muted/80 hover:text-foreground",
        magic:
          "magic-gradient text-white shadow-lg shadow-purple-500/25 hover:brightness-110 primary-glow",
